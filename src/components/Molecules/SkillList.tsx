  ...
  return (
    <div className='relative mb-24'>
      ...
      <div className='flex flex-wrap justify-center bg-white rounded-2xl'>
        <SkillDetail language='Laravel' icon={faLaravel} width='w-1/5'>
          {`経験年数 2年\n本業、副業含め常に扱っています。0→1からのサービス開発を担当。`}
        </SkillDetail>
        <SkillDetail language='Nuxt.js' icon={faVuejs} width='w-1/5'>
        ...
        <SkillDetail language='Symfony' icon={faSymfony} width='w-1/5'>
          {`経験年数 0.5年\nSymfonyを導入しているEC-CUBEを利用した通販サイトのリニューアル業務を担当。`}
        </SkillDetail>
        <SkillDetail language='Ruby on Rails' icon={faR} width='w-1/5'>
          {`経験年数 0.5年\nSymfonyを導入しているEC-CUBEを利用した通販サイトのリニューアル業務を担当。`}
        </SkillDetail>
        <SkillDetail language='Python' icon={faPython} width='w-1/5'>
