  ...
  return (
    <div className='relative mb-24'>
      ...
      <div className='flex flex-wrap justify-start bg-white rounded-[4.5rem] sm:rounded-2xl sm:w-11/12 sm:mx-auto'>
        ...
        <SkillDetail language='Nuxt.js' icon={faVuejs} width='w-2/5 lg:w-1/4'>
        ...
        <SkillDetail language='Symfony' icon={faSymfony} width='w-2/5 lg:w-1/4'>
          {`経験年数 0.5年\nSymfonyを導入しているEC-CUBEを利用した通販サイトのリニューアル業務を担当。`}
        </SkillDetail>
        <SkillDetail language='Ruby on Rails' icon={faR} width='w-2/5 lg:w-1/4'>
          {`経験年数 0.5年\nSymfonyを導入しているEC-CUBEを利用した通販サイトのリニューアル業務を担当。`}
        </SkillDetail>
        <SkillDetail language='Python' icon={faPython} width='w-2/5 lg:w-1/4'>
