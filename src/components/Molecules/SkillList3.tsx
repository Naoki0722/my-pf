  ...
  return (
    <div className='relative mb-24'>
      ...
      <div className='flex flex-wrap justify-center bg-white rounded-2xl'>
        <SkillDetail language='Github' icon={faGithub} width='w-1/5'>
          {`経験年数 2.5年\n2016年に勤務した自社開発の会社の時から利用。開発者のリリーサーとしてGithubの管理やデプロイ等の対応経験あり。一部、クラウド環境への自動デプロイや作業効率化としてGithub Actionsの作成も。`}
        </SkillDetail>
        <SkillDetail language='MySQL' icon={faDatabase} width='w-1/5'>
        ...
        <SkillDetail language='React' icon={faReact} width='w-1/5'>
