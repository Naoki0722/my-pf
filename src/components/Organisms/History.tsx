...
const History: NextPage = () => {
  return (
    <div id='history' className='relative history-area py-8 sm:py-18'>
      <div className='history-text bg-white w-11/12 sm:w-3/4 mx-auto py-8 sm:py-12 px-3 sm:px-12 tracking-wider sm:my-12'>
        <h2 className='border-b-2 border-gray-500 pb-4 text-3xl sm:text-4xl'>経歴</h2>
        <div className='mt-4 relative z-10'>
          <div className='flex w-full sm:text-xl'>
            <div className='history-line w-3 sm:w-8 sm:mr-8'></div>
            <div className='flex sm:w-5/6 pb-4'>
      ...
      <div className='absolute top-[8.2rem] sm:top-28 left-7 sm:left-48 w-12 sm:w-full'>
        <Image
